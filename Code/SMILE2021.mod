//Import:ecl:Workshops.SMILE_2021.BWR_Hello
...
//Import:ecl:Workshops.SMILE_2021.BWR_Train
IMPORT $;
IMPORT ML_Core;
...
//Import:ecl:Workshops.SMILE_2021.BWR_ViewData
IMPORT $;
...
// Teste do modelo
// OUTPUT($.modFile.File(propertyid=68570)); //121520
// OUTPUT($.modFile.File(propertyid=3703)); //324280

// Teste da Função
// $.FN_GetPrice(95451,118720,2011,14774,1437,3,2,1,1968); //~130k


//Import:ecl:Workshops.SMILE_2021.FN_GetPrice
IMPORT $;
IMPORT ML_Core;
IMPORT LearningTrees as LT;
...
//Import:ecl:Workshops.SMILE_2021.modFile
...
END;
//Import:ecl:Workshops.SMILE_2021.modPrep
IMPORT $;
...
END;
//Import:ecl:Workshops.SMILE_2021.modSeg
IMPORT $,ML_Core;
...
//Import:ecl:Workshops.SMILE_2021.XTab_PriceState
IMPORT $;
